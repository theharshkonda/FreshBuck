...
import com.harsh.freshbuck.Utilities.AdminHome.CartItems;
                    ...
                    protected void onBindViewHolder(@NonNull final Holder holder, int position, @NonNull final HomeModel model) {
                        ...
                        holder.imageViewCheck.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Toast.makeText(getContext().getApplicationContext(), "initotal"+initTotal+"--"+TotalPriceCart.getText().toString(), Toast.LENGTH_SHORT).show();
                                Toast.makeText(getContext().getApplicationContext(), "initcart"+initCart+"--"+holder.cart_totalRate.getText().toString(), Toast.LENGTH_SHORT).show();
                        ...
                        databaseReference.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                if (mobile == null && address == null) {
                                    ...
                                    materialButton.setVisibility(View.GONE);
                                    Snackbar snackBar = Snackbar.make(requireView(), "Fill The Address Section First...", Snackbar.LENGTH_LONG).setAction("Yes", new View.OnClickListener() {
                                        @Override
